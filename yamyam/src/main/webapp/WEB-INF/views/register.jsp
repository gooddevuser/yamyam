						...
						<form>
							<div class="form-group form-inline">
								<div class="form-group col-lg-6 col-md-12 name">
									<input type="text" class="form-control" id="name" placeholder="성함" onfocus="this.placeholder = ''"
									 onblur="this.placeholder = '성함'">
								</div>
								<div class="form-group col-lg-6 col-md-12 email">
									<input type="email" class="form-control" id="email" placeholder="이메일" onfocus="this.placeholder = ''"
							...
							<div class="form-group">
								<textarea class="form-control mb-10" rows="5" name="message" placeholder="자기소개" onfocus="this.placeholder = ''"
								 onblur="this.placeholder = '자기소개'" required=""></textarea>
							</div>
							<a href="#" class="primary-btn">회원가입 하기</a>
						</form>
					</div>
				</div>
			</div>
