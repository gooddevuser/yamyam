					...
					<div class="single-post row">
						...
						<div class="col-lg-12">
							...
							<div class="row mt-30 mb-30">
								<div class="col-6">
									<img class="img-fluid" src="/yamyam/resources/img/blog/post-img1.jpg" alt="">
								</div>
								<div class="col-6">
									<img class="img-fluid" src="/yamyam/resources/img/blog/post-img2.jpg" alt="">
								</div>
					...
					<div class="navigation-area">
						<div class="row">
							<div class="col-lg-6 col-md-6 col-12 nav-left flex-row d-flex justify-content-start align-items-center">
								<div class="thumb">
									<a href="#"><img class="img-fluid" src="/yamyam/resources/img/blog/prev.jpg" alt=""></a>
								</div>
								<div class="arrow">
							...
							<div class="col-lg-6 col-md-6 col-12 nav-right flex-row d-flex justify-content-end align-items-center">
								...
								<div class="thumb">
									<a href="#"><img class="img-fluid" src="/yamyam/resources/img/blog/next.jpg" alt=""></a>
								</div>
							</div>
						</div>
					</div>
